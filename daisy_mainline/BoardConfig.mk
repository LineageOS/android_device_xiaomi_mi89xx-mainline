...
BOARD_VENDOR_KERNEL_MODULES_LOAD := \
    $(strip $(shell cat $(DEVICE_PATH)/mi8953_a/modprobe/modules.load.*))
BOARD_RECOVERY_RAMDISK_KERNEL_MODULES_LOAD := \
    $(strip $(shell cat $(DEVICE_PATH)/mi8953_a/modprobe/modules.load.basic)) \
    $(strip $(shell cat $(DEVICE_PATH)/mi8953_a/modprobe/modules.load.drm)) \
    $(strip $(shell cat $(DEVICE_PATH)/mi8953_a/modprobe/modules.load.panel.*)) \
    $(strip $(shell cat $(DEVICE_PATH)/mi8953_a/modprobe/modules.load.touchscreen))
RECOVERY_KERNEL_MODULES := \
    $(strip $(shell cat $(DEVICE_PATH)/mi8953_a/modprobe/modules.include_dep.basic)) \
    $(strip $(shell cat $(DEVICE_PATH)/mi8953_a/modprobe/modules.include_dep.drm)) \
    $(strip $(shell cat $(DEVICE_PATH)/mi8953_a/modprobe/modules.load.basic)) \
    $(strip $(shell cat $(DEVICE_PATH)/mi8953_a/modprobe/modules.load.drm)) \
...
# OTA
TARGET_OTA_ASSERT_DEVICE := daisy_mainline,daisy
